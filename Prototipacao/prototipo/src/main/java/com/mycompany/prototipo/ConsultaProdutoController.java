...
public class ConsultaProdutoController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        tbColPreco.setCellValueFactory(new PropertyValueFactory<Produto, Float>("preco"));
        tbColQtde.setCellValueFactory(new PropertyValueFactory<Produto, Integer>("qtde"));
        tbColLoc.setCellValueFactory(new PropertyValueFactory<Produto, String>("nome"));
